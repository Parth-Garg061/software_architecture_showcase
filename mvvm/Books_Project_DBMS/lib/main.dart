...
import 'package:books_project_dbms/views/home_view.dart';
...
void main() {
  runApp(
    MultiProvider(
        providers: [
          ChangeNotifierProvider(create: (_) => HomeViewModel()..loadSavedValue()),
          ChangeNotifierProvider(create: (_) => BookListViewModel()),
          ChangeNotifierProvider(create: (_) => AddBookViewModel())
        ],
      child: MyApp(),
    ),
  );
